...
Previous: [Building This Blog (part 1) - Humble Beginnings](./01-humble-beginnings.md)
...
We will discuss the first three points in detail in this post. The last three points (internal link interception and direct URL navigation) are discussed in [Building This Blog (part 3) - Routing for GitHub Pages (part 2)](./03-routing-for-github-pages-02.md)
...
When a user navigated directly to a URL, e.g. `https://isaac-defrain.github.io/blog/01-humble-beginnings`, or even refreshed the page, GitHub Pages would return a 404 error because it was looking for an _actual file at that path_ - but this was actually a _client-side route_.
...
[Part 3: Routing for GitHub Pages (part 2)](./03-routing-for-github-pages-02.md)
